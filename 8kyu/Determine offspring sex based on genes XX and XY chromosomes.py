...
and contain one of two types of sex chromosomes. 
...
Determine if the sex of the offspring will be male or 
female based on the X or Y chromosome present in the male's sperm.

If the sperm contains the X chromosome, 
return "Congratulations! You're going to have a daughter."; 
If the sperm contains the Y chromosome, return "Congratulations! 
...
def chromosome_check(sperm):
    return son if sperm == 'XY' else daughter
